...
void WardenMac::Init(WorldSession* pClient, BigNumber* K)
{
    ...
    */
    ...
    TC_LOG_DEBUG("anticheat", "WARDEN:           Server side warden for client %u initializing...", pClient->GetAccountId());
...
void WardenMac::HandleData(ByteBuffer &buff)
{
    ...
    {
        TC_LOG_DEBUG("anticheat", "WARDEN:           Handle data failed: SHA1 hash is wrong!");
        //found = true;
    }
    ...
    {
        TC_LOG_DEBUG("anticheat", "WARDEN:           Handle data failed: MD5 hash is wrong!");
        //found = true;
    }
