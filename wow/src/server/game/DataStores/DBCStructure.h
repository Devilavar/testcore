...
struct MapEntry
{
    ...
    bool IsDungeon() const { return !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, MapID, NULL) && (map_type == MAP_INSTANCE || map_type == MAP_RAID); }
    bool IsNonRaidDungeon() const { return !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, MapID, NULL) && map_type == MAP_INSTANCE; }
    bool Instanceable() const { return !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, MapID, NULL) && (map_type == MAP_INSTANCE || map_type == MAP_RAID || map_type == MAP_BATTLEGROUND || map_type == MAP_ARENA); }
    bool IsRaid() const { return !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, MapID, NULL) && map_type == MAP_RAID; }
