...
const std::string CustomItemExtendedCostfmt="pppppppppppppppa";
const std::string CustomItemExtendedCostIndex="Id";
...
const std::string CustomWorldSafeLocsfmt="pppppa";
const std::string CustomWorldSafeLocsIndex="ID";
