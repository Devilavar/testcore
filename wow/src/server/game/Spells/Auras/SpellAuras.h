...
class Aura
{
    ...
    public:
        ...
        bool IsBreakableByAnyDamage(Unit* exclude = NULL) const;

        void SetDmgPctModifer(float value) { m_staticDmgPctMod = value; }
        float GetDmgPctModifier() { return m_staticDmgPctMod; }
        void SetCritModifier(float value) { m_staticCritMod = value; }
        float GetCritModifier() { return m_staticCritMod; }
    ...
    protected:
        ...
        float m_staticDmgPctMod; // Damage % modifiers roll
        float m_staticCritMod; // Crit rolls
