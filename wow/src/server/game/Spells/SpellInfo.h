...
public:
    ...
    bool HasTriggerSpell() const;
    bool HasPositiveTriggerSpell() const;
    ...
    bool IsDstSpell() const;

    SpellCastResult CheckShapeshift(uint32 form) const;
    SpellCastResult CheckLocation(uint32 map_id, uint32 zone_id, uint32 area_id, Player const* player = NULL) const;
    SpellCastResult CheckTarget(Unit const* caster, WorldObject const* target, bool implicit = true, bool ignoreAurReq = false) const;
