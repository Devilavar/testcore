...
class Channel
{
    ...
    public:
        ...
        typedef std::list<std::pair<uint64 /*guid*/, std::string /*message*/> > ChatMessageContainer;
        ChatMessageContainer::const_iterator GetChatMessagesBegin() { return messageStore.begin(); }
        ChatMessageContainer::const_iterator GetChatMessagesEnd() { return messageStore.end(); }
        size_t GetChatMessagesSize() const { return messageStore.size(); }
        void AddStoredMessage(uint64 guid, std::string message);
        void DeleteOldestStoredMessage();
    ...
    private:
        ...
        ChatMessageContainer messageStore;
};
#endif
