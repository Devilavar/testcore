...
void Channel::AddStoredMessage(uint64 guid, std::string message)
{
    messageStore.push_back(std::make_pair(guid, message));
}

void Channel::DeleteOldestStoredMessage()
{
    messageStore.erase(messageStore.begin());
}
