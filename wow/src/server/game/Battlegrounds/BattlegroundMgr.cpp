            ...
            switch (arenaType)
            {
                ...
                case ARENA_TYPE_5v5:
                    if (sWorld->getBoolConfig(CONFIG_ARENA_5v5_TEAM_ENABLE) == 1)
                        ...
                        return BATTLEGROUND_QUEUE_NONE;
				case ARENA_TYPE_1v1:
                    // TODO: custom check if 1v1 is enabled or not
                    //if (sWorld->getBoolConfig(CONFIG_ARENA_1v1_TEAM_ENABLE) == 1)
...
BattlegroundContainer BattlegroundMgr::GetAllBattlegroundsWithTypeId(BattlegroundTypeId bgTypeId)
{
