...
class Battleground
{
    public:
        ...
        uint32 GetBattleTime() const        { return BattleTime; }
        ...
        uint32 GetFreeSlotsForTeam(uint32 Team, bool basic = false) const;
    ...
    private:
        ...
        uint32 m_StartTime;
        time_t m_ArmoryStartTime;
        time_t m_ArmoryEndTime;
        uint32 FinishTime;
        uint32 BattleTime;
        uint32 PrepareTime;
        uint32 TotalTime;
