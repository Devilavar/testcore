...
bool BattlegroundDS::SetupBattleground()
{
    ...
    if (!AddObject(BG_DS_OBJECT_DOOR_1, BG_DS_OBJECT_TYPE_DOOR_1, 1350.95f, 817.2f, 20.8096f, 3.15f, 0, 0, 0.99627f, 0.0862864f, RESPAWN_IMMEDIATELY)
        ...
        // buffs
        || !AddObject(BG_DS_OBJECT_BUFF_1, BG_DS_OBJECT_TYPE_BUFF_1, 1263.042f, 818.977f, 3.159f, 4.64562f, 0, 0, 0.730314f, -0.683111f, 120)
        || !AddObject(BG_DS_OBJECT_BUFF_2, BG_DS_OBJECT_TYPE_BUFF_2, 1320.396f, 762.981f, 3.159f, 1.55194f, 0, 0, 0.700409f, 0.713742f, 120)
        // knockback creatures
        || !AddCreature(BG_DS_NPC_TYPE_WATER_SPOUT, BG_DS_NPC_WATERFALL_KNOCKBACK, 1291.458f, 790.883f, 7.115f, 3.054326f, TEAM_NEUTRAL, RESPAWN_IMMEDIATELY)
...
void BattlegroundDS::KnockBackPlayer(Player* Player, float angle, float horizontalSpeed, float verticalSpeed)
{
