...
{ // These values are NOT blizzlike... need the correct data!
    ...
    BG_DS_WATERFALL_KNOCKBACK_TIMER              = 1000,

    BG_DS_PIPE_KNOCKBACK_FIRST_DELAY             = 10000,
...
class BattlegroundDS : public Battleground
{
    ...
    private:
        ...
        void KnockBackPlayer(Player* Player, float angle, float horizontalSpeed, float verticalSpeed);
