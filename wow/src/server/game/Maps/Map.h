...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        bool Instanceable() const { return i_mapEntry && i_mapEntry->Instanceable() && !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, GetId(), NULL); }
        bool IsDungeon() const { return i_mapEntry && i_mapEntry->IsDungeon() && !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, GetId(), NULL); }
        bool IsNonRaidDungeon() const { return i_mapEntry && i_mapEntry->IsNonRaidDungeon() && !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, GetId(), NULL); }
        bool IsRaid() const { return i_mapEntry && i_mapEntry->IsRaid() && !DisableMgr::IsDisabledFor(DISABLE_TYPE_INSTANCING, GetId(), NULL); }
        ...
        bool IsInAir(uint32 phasemask, float x, float y, float z, bool vmap = true, float maxSearchDist = DEFAULT_HEIGHT_SEARCH) const;
