...
void WorldSession::HandleCharDeleteOpcode(WorldPacket& recvData)
{
    ...
    {
        TC_LOG_ERROR("network", "Possible Hack Attempt: Character %u cannot be deleted by account %u", GUID_LOPART(guid), _accountId);
        KickPlayer();
        return;
    }
...
void WorldSession::HandlePlayerLogin(LoginQueryHolder* holder)
{
    ...
    ScheduleEvent(SESSION_EVENT_DISPLAY_ACCOUNT_MSG, 10000);
