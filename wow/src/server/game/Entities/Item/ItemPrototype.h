...
enum ItemFlagsCustom
{
    ...
    ITEM_FLAGS_CU_SKIP_CLASS_CHECK      = 0x0100    // Item will skip AllowableClass check in SendListInventory
};
...
typedef std::unordered_map<uint32, uint32> ItemFakeEntryContainer; // custom
