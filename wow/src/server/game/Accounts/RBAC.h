...
enum RBACPermissions
{
    ...
    // CUSTOM
    RBAC_PERM_COMMAND_WORLD_CHAT                             = 3000,
    RBAC_PERM_COMMAND_MALL                                   = 3001,
    

    // custom permissions 1000+
    RBAC_PERM_COMMAND_RESET_SEASON                          = 2000,
    RBAC_PERM_COMMAND_LIST_COMBAT                           = 2001,
    RBAC_PERM_COMMAND_RELOAD_CREATURE_OUTFITS               = 2002,
    RBAC_PERM_COMMAND_RELOAD_CHAT_FILTER                    = 2003,
    RBAC_PERM_COMMAND_ANTICHEAT                             = 2004,
    RBAC_PERM_COMMAND_ANTICHEAT_GLOBAL                      = 2005,
    RBAC_PERM_COMMAND_ANTICHEAT_PLAYER                      = 2006,
    RBAC_PERM_COMMAND_ANTICHEAT_DELETE                      = 2007,
    RBAC_PERM_COMMAND_ANTICHEAT_HANDLE                      = 2008,
    RBAC_PERM_COMMAND_ANTICHEAT_JAIL                        = 2009,
    RBAC_PERM_COMMAND_ANTICHEAT_WARN                        = 2010,
    RBAC_PERM_COMMAND_SPECTATE                              = 2011,
    RBAC_PERM_COMMAND_SPECTATE_SETVIEWPOINT                 = 2012,
    RBAC_PERM_COMMAND_SPECTATE_RESTOREVIEWPOINT             = 2013,
    RBAC_PERM_COMMAND_GRAVEYARD                             = 2014,
    RBAC_PERM_COMMAND_GRAVEYARD_ADD                         = 2015,
    RBAC_PERM_COMMAND_RELOAD_ITEMEXTENDEDCOST               = 2016,
    RBAC_PERM_MAX
};
