...
enum WorldIntConfigs
{
    ...
    CONFIG_CHAT_CHANNEL_PLAYEDTIME_REQ,
    CONFIG_CHAT_WHISPER_PLAYEDTIME_REQ,
    CONFIG_CHAT_SAY_PLAYEDTIME_REQ,
    CONFIG_CHAT_FILTER_ENABLE,
    CONFIG_CHAT_FILTER_MAX_MSGS,
    CONFIG_TRADE_PLAYEDTIME_REQ,
    CONFIG_TICKET_PLAYEDTIME_REQ,
    CONFIG_AUCTION_PLAYEDTIME_REQ,
    CONFIG_MAIL_PLAYEDTIME_REQ,
    ...
    CONFIG_WINTERGRASP_CUSTOMREWARD_ITEM,
    CONFIG_WINTERGRASP_CUSTOMREWARD_AMOUNT,
...
class World
{
    public:
        ...
        uint16 GetPlayerSecurityLimit() const { return m_allowedSecurityLevel; }
        void SetPlayerSecurityLimit(uint16 sec);
        ...
        uint32 GetRealmBuild() { return m_realmbuild; }
        int32 GetRealmPort();

        // auth attacker counters/array, enable/disable
        int auth_cnt;
        uint32 login_counter[5000][1];
        uint32 auth_flood_mode;
