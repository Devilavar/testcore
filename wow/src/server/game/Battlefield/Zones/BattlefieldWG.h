...
const WintergraspObjectPositionData WGKeepNPC[WG_MAX_KEEP_NPC] =
{
    ...
    // North
    { 5374.615723f, 2791.225098f, 409.238586f, 2.608824f, BATTLEFIELD_WG_NPC_STONE_GUARD_MUKAR, BATTLEFIELD_WG_NPC_KNIGHT_DAMERON }, // Stone Guard Mukar
...
const WintergraspTowerData AttackTowers[WG_MAX_ATTACKTOWERS] =
{
    // West tower
    {
        ...
        1,
        {
            ...
            { 4689.29f,     2849.9f,      388.825f,    0.255069f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4757.75f,     2894.98f,     375.999f,    0.0830647f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4764.02f,     3278.36f,     365.617f,    6.02302f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4764.81f,     2868.63f,     377.873f,    0.305332f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4618.41f,     3350.51f,     366.025f,    2.82252f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4619.46f,     3353.38f,     365.976f,    2.80289f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4680.88f,     2383.13f,     370.832f,    0.399576f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4683.00f,     2380.63f,     378.381f,    0.391719f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
        },
        0,
        {
            { 4782.22f, 2900.96f, 374.519f, 6.27514f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4777.91f, 2872.74f, 375.576f, 0.301405f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4782.22f, 2900.96f, 374.519f, 6.27514f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4844.14f, 2879.78f, 374.717f, 6.12513f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4848.41f, 2904.68f, 372.664f, 6.11335f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
        }
    },
    ...
    // South Tower
    {
        ...
        5,
        {
            ...
            { 4765.38f, 3282.49f, 365.614f, 5.86202f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
        },
        6,
        {
            ...
            { 4771.77f, 3305.55f, 365.957f, 6.03873f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4521.97f, 2811.66f, 391.712f, 3.2977f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4524.56f, 2806.71f, 391.468f, 4.50328f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
        },
        0,
        {
            { 4773.34f, 3303.18f, 365.47f, 6.19581f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4525.69f, 2812.79f, 391.135f, 0.328893f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4530.91f, 2355.37f, 371.382f, 3.50347f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4533.11f, 2350.06f, 370.818f, 3.4642f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4686.26f, 2875.84f, 387.787f, 0.156894f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
        },
    },
    ...
    // East Tower
    {
        ...
        4,
        {
            ...
            { 4668.18f, 2414.78f, 371.381f, 0.364233f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4669.97f, 2410.46f, 370.82f, 0.411357f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
        },
        5,
        {
        ...
        0,
        {
            { 4543.26f, 2325.38f, 370.812f, 3.61185f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4546.27f, 2321.35f, 371.389f, 3.56865f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4610.61f, 3317.51f, 366.051f, 2.81467f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
            { 4611.49f, 3320.63f, 366.443f, 2.87357f, BATTLEFIELD_WG_NPC_GUARD_H, BATTLEFIELD_WG_NPC_GUARD_A },
        },
    },
};
