...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_ERR_NO_EQUIP                   = 11137,

    // Beastmaster
    LANG_ERR_INVALID_CLASS              = 11130,
    LANG_ERR_DISMISS_PET                = 11131,
    LANG_ERR_NO_STATS                   = 11132,
    LANG_PET_CREATED                    = 11133,
    LANG_ERR_INVALID_TALENT             = 11134,
