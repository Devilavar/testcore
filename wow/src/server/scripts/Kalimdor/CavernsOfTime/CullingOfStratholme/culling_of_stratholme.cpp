...
public:
    ...
    struct npc_arthasAI : public npc_escortAI
    {
        ...
        void JumpToNextStep(uint32 uiTimer)
        {
            phaseTimer = uiTimer;
            ++step;
            instance->SetData(DATA_ARTHAS_STEP, step);
        }
                ...
                if (phaseTimer <= diff)
                {
                    switch (step)
                    {
                        ...
                        case 3:
                            ...
                            {
                                uther->MonsterSay("Watch your tone with me, boy. You may be the prince, but I'm still your superior as a paladin!", LANG_UNIVERSAL, 0); /* 102 */
                            }
                            JumpToNextStep(8000);
                            break;
                        case 4:
                        ...
                        case 6:
                            if (Creature* uther = Unit::GetCreature(*me, utherGUID))
                                uther->MonsterSay("What?", LANG_UNIVERSAL, 0); /* 105 */
                            JumpToNextStep(1000);
                            break;
                        case 7:
                            Talk(SAY_PHASE106);
                        ...
                        case 8:
                            if (Creature* uther = Unit::GetCreature(*me, utherGUID))
                                 uther->MonsterSay("I'm sorry, Arthas. I can't watch you do this.", LANG_UNIVERSAL, 0); /* 107 */
                            JumpToNextStep(6000);
                            break;
                        case 9:
                            Talk(SAY_PHASE108);
                        ...
                        case 10:
                            if (Creature* uther = Unit::GetCreature(*me, utherGUID))
                                 uther->MonsterSay("You are not my king yet, boy! Nor would I obey that command even if you were!", LANG_UNIVERSAL, 0); /* 109 */
                            JumpToNextStep(8000);
                            break;
                        case 11:
                            Talk(SAY_PHASE110);
                        ...
                        case 12:
                            if (Creature* uther = Unit::GetCreature(*me, utherGUID))
                                 uther->MonsterSay("Treason? Have you lost your mind, Arthas?", LANG_UNIVERSAL, 0); /* 111 */
                            JumpToNextStep(4000);
                            break;
                        case 13:
                            Talk(SAY_PHASE112);
                        ...
                        case 14:
                            if (Creature* jaina = Unit::GetCreature(*me, jainaGUID))
                                 jaina->MonsterSay("Arthas! You can't just--", LANG_UNIVERSAL, 0); /* 113 */
                            JumpToNextStep(3000);
                            break;
                        case 15:
                            Talk(SAY_PHASE114);
                        ...
                        case 16:
                            if (Creature* uther = Unit::GetCreature(*me, utherGUID))
                                uther->MonsterSay("You've just crossed a terrible threshold, Arthas.", LANG_UNIVERSAL, 0); /* 115 */
                            JumpToNextStep(4000);
                            break;
                        case 17:
                            if (Creature* uther = Unit::GetCreature(*me, utherGUID))
                        ...
                        case 20:
                            if (Creature* jaina = Unit::GetCreature(*me, jainaGUID))
                                jaina->MonsterSay("I'm sorry, Arthas. I can't watch you do this.", LANG_UNIVERSAL, 0); /* 117 */
                            JumpToNextStep(3000);
                            break;
                        case 21:
                            SetEscortPaused(false);
                        ...
                        case 36:
                            if (Creature* malganis = me->SummonCreature(NPC_MAL_GANIS, 2117.349f, 1288.624f, 136.271f, 1.37f, TEMPSUMMON_TIMED_DESPAWN, 60000))
                            {
                                malganis->MonsterSay("Yes, this is the beginning. I've been waiting for you, young prince. I am Mal'Ganis.", LANG_UNIVERSAL, 0); /*206*/
                        ...
                        case 38:
                            if (Creature* malganis = Unit::GetCreature(*me, malganisGUID))
                                malganis->MonsterSay("As you can see, your people are now mine. I will now turn this city household by household, until the flame of life has been snuffed out.", LANG_UNIVERSAL, 0);
                            JumpToNextStep(17000);
                            break;
                        case 39:
                            if (Creature* malganis = Unit::GetCreature(*me, malganisGUID))
