                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_BONE_STORM_BEGIN:
                            ...
                            me->ApplySpellImmune(0, IMMUNITY_ID, 62124, true); // Paladin Hand of Reckoning
                            me->ApplySpellImmune(0, IMMUNITY_ID, 31789, true); // Paladin Righteous Defense
                        ...
                        case EVENT_BONE_STORM_END:
                            ...
                            me->ApplySpellImmune(0, IMMUNITY_ID, 62124, false); // Paladin Hand of Reckoning
                            me->ApplySpellImmune(0, IMMUNITY_ID, 31789, false); // Paladin Righteous Defense
    ...
    public:
        ...
        struct npc_coldflameAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(Unit* owner) override
            {
                ...
                float floor = me->GetPositionZ();
                me->UpdateAllowedPositionZ(pos.GetPositionX(), pos.GetPositionY(), floor);

                me->NearTeleportTo(pos.GetPositionX(), pos.GetPositionY(), floor, me->GetOrientation());
