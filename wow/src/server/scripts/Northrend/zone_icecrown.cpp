...
enum eValiantText
{
    NPC_FACTION_VAILIANT_TEXT_SAY_START_1   = 0, /* TODO */
    NPC_FACTION_VAILIANT_TEXT_SAY_START_2   = 0,
    NPC_FACTION_VAILIANT_TEXT_SAY_START_3   = 0,
    NPC_ARGENT_VAILIANT_TEXT_SAY_START      = 0,
    NPC_ARGENT_VAILIANT_TEXT_SAY_WIN        = 0,
    NPC_ARGENT_VAILIANT_TEXT_SAY_LOSE       = 0,
    NPC_FACTION_VAILIANT_TEXT_SAY_WIN_1     = 0,
    NPC_FACTION_VAILIANT_TEXT_SAY_WIN_2     = 0,
    NPC_FACTION_VAILIANT_TEXT_SAY_LOSE     = 0,
};
...
public:
    ...
    struct npc_argent_valiantAI : public ScriptedAI
    {
        ...
        {
            me->DespawnOrUnsummon(7000);
            Talk(NPC_ARGENT_VAILIANT_TEXT_SAY_LOSE);
        }
...
enum eChampionText
{
    NPC_FACTION_CHAMPION_TEXT_SAY_START_1     = 0,//    Get Ready !
    NPC_FACTION_CHAMPION_TEXT_SAY_START_2     = 1,//    Let the battle begin!
    NPC_FACTION_CHAMPION_TEXT_SAY_START_3     = 2,//    Prepare !
    NPC_ARGENT_CHAMPION_TEXT_SAY_START         = 3,//    You think you have the courage in you? We'll see.
    NPC_ARGENT_CHAMPION_TEXT_SAY_WIN         = 4,//    Impressive demonstration. I think you are quite able to join the ranks of the brave.
    NPC_ARGENT_CHAMPION_TEXT_SAY_LOSE         = 5,//    I won. You'll probably have more luck next time.
    NPC_FACTION_CHAMPION_TEXT_SAY_WIN_1     = 6,//    I am defeated. Nice fight!
    NPC_FACTION_CHAMPION_TEXT_SAY_WIN_2     = 7,//    Looks like I underestimated your skills. Well done.
    NPC_FACTION_CHAMPION_TEXT_SAY_LOSE     = 8,//    I won. You'll probably have more luck next time.
};
    ...
    struct npc_argent_championAI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* pDoneBy, uint32& uiDamage) override
        {
            if(pDoneBy)
            {
                if (uiDamage > me->GetHealth() && (pDoneBy->GetTypeId() == TYPEID_PLAYER || pDoneBy->GetOwner()))
                {
                    Talk(NPC_ARGENT_CHAMPION_TEXT_SAY_WIN);
                    uiDamage = 0;
        ...
        {
        me->setFaction(35);
        //me->ForcedDespawn(5000); -- have to find the correct function asap..
        Talk(NPC_ARGENT_CHAMPION_TEXT_SAY_LOSE);
        me->CombatStop(true);
        }
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            Talk(NPC_ARGENT_CHAMPION_TEXT_SAY_START);
        }
...
public:
    ...
    {
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "I am ready to fight!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "How do the Argent Crusader raiders fight?", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+2);
        player->SEND_GOSSIP_MENU(GOSSIP_TEXTID_SQUIRE_DANNY, pCreature->GetGUID());
        return true;
    }
    ...
    bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 /*uiSender*/, uint32 uiAction) override
    {
        ...
        pCreature->SummonCreature(NPC_ARGENT_CHAMPION,8562.836914f,1099.153931f,556.787598f,5.026550f); // TODO (Recover the actual coordinates)
        }
        return true;
    }
