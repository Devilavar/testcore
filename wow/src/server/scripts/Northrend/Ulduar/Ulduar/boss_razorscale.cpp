    ...
    public:
        ...
        struct boss_razorscaleAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/) override
            {
                ...
                if (Creature* controller = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_RAZORSCALE_CONTROL)))
                    controller->AI()->Reset();
                instance->CompleteAchievement(2919); // @todo | proverka za raid mode
                instance->CompleteAchievement(2921);
                instance->CompleteAchievement(2923);
                instance->CompleteAchievement(2924);
            }
