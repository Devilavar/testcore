...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "global",         rbac::RBAC_PERM_COMMAND_ANTICHEAT_GLOBAL,     true,  &HandleAntiCheatGlobalCommand,         "", NULL },
            { "player",         rbac::RBAC_PERM_COMMAND_ANTICHEAT_PLAYER,     true,  &HandleAntiCheatPlayerCommand,         "", NULL },
            { "delete",         rbac::RBAC_PERM_COMMAND_ANTICHEAT_DELETE,  true,  &HandleAntiCheatDeleteCommand,         "", NULL },
