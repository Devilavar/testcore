/*
* Copyright (C) Eternal-WoW (http://Eternal-WoW.com)
*
*  This repository belongs to Eternal-WoW (http://Eternal-WoW.com)
*  By viewing this repository, you hereby agree to our terms of use.
*   *In addition, you agree that you will not use our repository for any
*  purpose besides learning, and/or helping to better the project.
*
*  TERMS OF USE:
*  You will not distribute any content located in this repository,
*  unless approved by an administrator of the repository.
*
*  In the event your access is revoked to this repository, you agree that you
*  will remove any content that was obtained through this repository from your
*  computer.
*
* Eternal-WoW is a MMORPG Framework written mostly in C++. It is closed source, 
* and supported by the developers of Eternal-WoW. It is derived from MaNGOS
* and TrinityCore, the Massive Network Game Object Server, and is based on the
* code of these projects with extensive changes over time to optimize, improve
