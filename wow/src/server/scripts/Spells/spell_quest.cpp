...
/*
Support for quest 'It Was The Orcs, Honest!' (11670)
*/
enum ItWasTheOrcs
{
    SPELL_ORC_MALE_DISGUISE     = 45760,
    SPELL_ORC_FEMALE_DISGUISE   = 45762,    
};

class spell_q11670_it_was_the_orcs : public SpellScriptLoader
{
    public:
        spell_q11670_it_was_the_orcs() : SpellScriptLoader("spell_q11670_it_was_the_orcs") { }

        class spell_q11670_it_was_the_orcs_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_q11670_it_was_the_orcs_SpellScript);

            bool Validate(SpellInfo const* /*spellEntry*/) override
            {
                if (!sSpellMgr->GetSpellInfo(SPELL_ORC_MALE_DISGUISE) || !sSpellMgr->GetSpellInfo(SPELL_ORC_FEMALE_DISGUISE))
                    return false;
                return true;
            }
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                PreventHitDefaultEffect(effIndex);
                if (Player* target = GetHitPlayer())
                    target->CastSpell(target, target->getGender() == GENDER_MALE ? SPELL_ORC_MALE_DISGUISE : SPELL_ORC_FEMALE_DISGUISE, true);                    

            }

            void Register() override
            {
                OnEffectHitTarget += SpellEffectFn(spell_q11670_it_was_the_orcs_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };

        SpellScript* GetSpellScript() const override
        {
            return new spell_q11670_it_was_the_orcs_SpellScript();
        }
};
...
/*######
## Quest: "It's all fun and games" http://www.wowhead.com/quest=12892 & http://www.wowhead.com/quest=12887 - thanks to Lopin for explaining how spellscript should work
######*/
enum eQuest12892_12887
{
    // Spells
    SPELL_OCULAR_KILL_CREDIT
};

class spell_q12892_12887_ocular_death : public SpellScriptLoader
{
    public:
        spell_q12892_12887_ocular_death() : SpellScriptLoader("spell_q12892_12887_ocular_death") { }

        class spell_q12892_12887_ocular_death_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_q12892_12887_ocular_death_SpellScript);
            ...
            void Register() override
            {
                OnEffectHitTarget += SpellEffectFn(spell_q12892_12887_ocular_death_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };

        SpellScript* GetSpellScript() const override
        {
            return new spell_q12892_12887_ocular_death_SpellScript();
        }
};
...
void AddSC_quest_spell_scripts()
{
    ...
    new spell_q11670_it_was_the_orcs();
    ...
    new spell_q12892_12887_ocular_death();
